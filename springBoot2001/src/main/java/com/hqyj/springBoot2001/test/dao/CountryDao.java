...
public interface CountryDao {
	...
	/*
	 * // 通过 countryId 查询该国家的所有城市cities // 封装结果集
	 * 
	 * @Results(value = { @Result(column = "country_id", property = "countryId"),
	 * 
	 * @Result(column = "country_id", property = "cities", javaType = List.class,
	 * many = @Many(select =
	 * "com.hqyj.springBoot2001.test.dao.CityDao.getCitiesByCountryId")) })
	 */
